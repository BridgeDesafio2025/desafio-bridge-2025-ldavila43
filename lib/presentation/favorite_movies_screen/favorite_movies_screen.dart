...
class _FavoriteMovieScreenState extends State<FavoriteMoviesScreen> {
  ...
  void _navigateToDetailRefresh(Medium medium) async {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            leading: medium.poster != null ? 
              Image.network(medium.poster!, width: 15.w, fit: BoxFit.cover) : 
              Container(width: 15.w, color: Colors.grey),

            onTap: () => _navigateToDetailRefresh(medium,)
          );
        }, 
      ),
    );
